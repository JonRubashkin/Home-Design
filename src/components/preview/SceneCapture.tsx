...
import { setCaptureHandles, type Capture3DHandles } from "../../lib/capture";
...
export function SceneCapture({
  ...
  useFrame(() => {
    ...
    setCaptureHandles(handles);
  });

  // Drop the global handle when this 3D pane unmounts (e.g. plan-only layout).
  useEffect(() => () => setCaptureHandles(null), []);
